          ...
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            ...
            <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="text" name="companyname" placeholder="Designation *" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <textarea class="form-control input-lg" rows="4" name="aboutme" placeholder="Roles & Responsibility *" required></textarea>
                </div>
              ...
              <div class="col-md-6 latest-job ">
                <div class="form-group">
                  <input class="form-control input-lg" type="password" name="password" placeholder="Password *" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <select class="form-control  input-lg" id="country" name="country">
                    <option selected="" value="" required>Select Country</option>
                    <?php
