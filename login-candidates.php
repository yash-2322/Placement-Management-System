    ...
    <div class="login-box-body bg-blue-200 text-black ">
      ...
      <form method="post" action="checklogin.php " class="text-xl">
        <div class="form-group has-feedback">
          ...
          <span class="glyphicon glyphicon-envelope form-control-feedback" style="margin-right: 7px;"></span>
        </div>
        <div class="form-group has-feedback">
          <input type="password" id="large" class="form-control" id="password" name="password" placeholder="Password">
          <i class="far fa-eye" id="togglePassword" style="margin-left: 288px; cursor: pointer;     position: relative; top: -24px;"></i>
