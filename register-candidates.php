            ...
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control input-lg" type="date" id="dob"  name="dob" placeholder="Date Of Birth" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="qualification" name="qualification" placeholder="Semester *" required>
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="stream" name="stream" placeholder="Stream *" required>
                </div>
                <div class="form-group checkbox">
                  <label><input type="checkbox" required> I accept rules and regulations</label>
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6 latest-job ">
                <div class="form-group">
                  <input class="form-control input-lg" type="password" id="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="password" placeholder="Password *" required>
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="password" id="cpassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="cpassword" placeholder="Confirm Password *" required>
                </div>
                ...
                <div class="form-group">
                  <label style="color: red;">Upload CV In PDF Format Only!</label>
